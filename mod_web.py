...
from mod_classes import GitInfo


def scrap_github(filter, listing):
    git = 'https://github.com/search?q='+filter
    url = get(git)
    print(url.text[:50])
    ...
    for rep in repertoire:
        ...
        print("*" * 50)
        print("{}, {}, {},{}, {}, {},{}, {}, {},{}, {}, {}".format(titre, star, topics, description, links, ver, rels, sponsors, packs, users, contributors, langs))
        listing.ajouter_info(GitInfo(titre, star, topics, description, links, ver, rels, sponsors, packs, users, contributors, langs))
        print(len(aspect))
